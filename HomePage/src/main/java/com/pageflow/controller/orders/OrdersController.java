...
public class OrdersController {
  ...
  public ModelAndView orderSuccess(@RequestParam Long ono, HttpSession session) {
    ...
    return new ModelAndView("order_success_page").addObject("list", list).addObject("delivery", delivery)
        .addObject("order", order).addObject("pointUsed", order.getPointUsed()); // pointUsed 추가
  }
  ...
  public ModelAndView orderList(Principal principal) {
    ...
    return new ModelAndView("order_list_page").addObject("orderList", orderList).addObject("cancelCount", cancelCount)
        .addObject("completeCount", completeCount).addObject("confirmCount", confirmCount)
  ...
  public ModelAndView read(@RequestParam(required = false) Long ono, Principal principal, HttpSession session) {
    ...
    return new ModelAndView("order_detail_list_page").addObject("read", read).addObject("member", memberProfile)
